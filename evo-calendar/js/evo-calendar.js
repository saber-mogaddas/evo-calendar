            ...
            _.initials = {
                ...
                dates: {
                    ...
                    tr: {
                        ...
                        noEventForToday: "Bugün için Faaliyet yok..",
                        noEventForThisDay: "Bugün için Faaliyet yok..",
                        previousYearText: "Geçen yıl",
                        nextYearText: "Gelecek yıl",
                        closeSidebarText: "sidebar Kapat",
                        closeEventListText: "Faaliyet listesini Kapat"
                    },
                    es: {
...
//        }
    ...
    EvoCalendar.prototype.addEventList = function (event_data) {
        ...
        markup += '<div class="event-icon"><div class="event-bul ' + event_data.type + '"';
        if (event_data.color) {
